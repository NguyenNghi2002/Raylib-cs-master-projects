...
namespace Engine.UI
{
    public static class Input
    {
        ...
        internal static bool IsKeyDown(Keys key) =>Raylib.IsKeyDown(key);
        internal static bool IsKeyPressed(Keys key) =>Raylib.IsKeyPressed(key);
        internal static bool IsKeyReleased(Keys key) =>Raylib.IsKeyReleased(key);
        internal static bool IsKeyuUp(Keys key) =>Raylib.IsKeyUp(key);
