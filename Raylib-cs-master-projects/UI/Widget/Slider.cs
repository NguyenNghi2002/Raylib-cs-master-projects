...
namespace Engine.UI
{
    ...
    public class SliderStyle : ProgressBarStyle
    {
        ...
        public static SliderStyle Create(Color background, Color backgroundBorder, Color afterKnob,Color afterKnobBorder)
        {
            var bg = new PrimitiveDrawable(background,backgroundBorder);
