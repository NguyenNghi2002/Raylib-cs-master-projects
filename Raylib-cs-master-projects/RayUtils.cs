...
namespace Engine
{
    ...
    public static  class RayUtils
    {
		...
		public static void DrawRectangleLinesPro(Rectangle rectangle, Vector2 org,float rotation,Color color)
		{
			var lineWidth = 2f;
		...
		public static bool IsWhole(this object value)
		{
		...
		/// If index is Out of bound, index will automaticly loop back to other side
		/// </summary>
		/// <typeparam name="T">value</typeparam>
		/// <param name="array">Collection of vale</param>
		/// <param name="index">index in array</param>
		/// <returns></returns>
		public static T GetLoopCollection<T>(T[] array,int index)
        {
			var n = array.Length;
			if (index >= n)
		...
		/// <summary>
		/// credit <see href="https://www.youtube.com/watch?v=hTJFcHutls8"/>
		/// </summary>
