...
namespace Examples
{
    public struct Light
    {
        ...
        public Matrix4x4 Projection => Matrix4x4.CreateOrthographicOffCenter(-10,10,-10,10,1,7);
        public Matrix4x4 LightSpace => View * Projection;
    ...
    public static class Rlights
    {
        ...
        public static void UpdateLightValues(Shader shader, Light light)
        {
            ...
            //float[] color = new[] { 1.0f, 1.0f, 0, 1f };
